...
public class ITAdapter extends RecyclerView.Adapter<ITAdapter.MyViewHolder> {
    private final List<ITDomain> itemList;
    ...
    public ITAdapter(List<ITDomain> itemList, Majors recyclerViewInterface) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ITDomain item = itemList.get(position);
    ...
    public void updateTextVisibility(int position) {
        ...
        item.setTextVisibility(newVisibility); // Assuming you have a method to set visibility in your ITDomain class
